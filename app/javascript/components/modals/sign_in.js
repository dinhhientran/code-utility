        ...
        <div class="col-md-6 p-4" style="border-right: 1px solid #aaa;padding-left: 3rem !important;">
          ...
          <div class="row more-nice-features">
            <div class="col-md-13">
              <ul>
                <li>
                  <div><span class="primary-color bullet">✓</span> <span class="feature">Share or Save Your Work</span></div>
                  <div class="description">Allow users to share or save beautified, converted code etc.</div>
                </li>
                <li class="mt-3">
          ...
          <div class="row mt-4">
            <div class="col-md-12">
              <button id="sign_in_github_btn" data-loading="false" class="btn btn-outline-primary">
                <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="sc-bdnylx gDXMLZ" style="color: #fff; margin-right: 5px;">
          ...
          <div class="row mt-3">
            <div class="col-md-12">
              <button id="sign_in_google_btn" data-loading="false"  class="btn btn-outline-primary">
                <svg width="20" height="20" fill="none" viewBox="0 0 22 20" style="margin-right: 5px">
